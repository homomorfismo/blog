...
$$
\begin{multline}
\| H(x)-H(y)\|=\big\| \| u\| x-\| v\| y\big\| = \big\|\| u \| x- \| v \| x + \| v \| x -\|v\| y)\|\le \\ \le \; \big\|\|u\|-\|v\|\big\|\cdot\|x\|+\|v\|\cdot\|x-y\| \le \\
\le  \|u - v\|\cdot\|x\|+\|v\|\cdot\|x-y\| =\\ =\|u - v\|\cdot\|x\|+\big\|\|v\|-\|u\|\big\|\cdot\|x-y\| + \|u\|\cdot\|x-y\|\le \\ \le\|u - v\|\cdot\|x\|+\|u-v\|\cdot\|x-y\| + \|u\|\cdot\|x-y\|
\end{multline}
$$
